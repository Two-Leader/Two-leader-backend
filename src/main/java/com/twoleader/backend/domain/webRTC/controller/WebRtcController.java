...
public class WebRtcController {
  ...
  //  public void offerMessage(@Payload OfferRequestMessage message,
  // @DestinationVariable("roomUuid") String roomUuid) {
  ...
  //  public void answerMessage(@Payload AnswerRequestMessage message,
  // @DestinationVariable("roomUuid") String roomUuid){
  ...
  //  public void iceCandidateMessage(@Payload IceCandidateRequestMessage message,
  // @DestinationVariable("roomUuid") String roomUuid){
  //    log.debug("[ws] answerMessage : user {}, roomUuid {}", message.getFrom(), roomUuid);
  //    simpMessagingTemplate.convertAndSend("/topic/"+roomUuid,message);
  //  }
