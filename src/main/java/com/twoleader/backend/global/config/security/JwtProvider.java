...
public class JwtProvider {
    ...
    private static final long ACCESS_REFRESH_TOKEN_EXPIRE_TIME = 1000* 60 * 60 *24*7; // Refresh 토큰 유효시간 일주일
    ...
    public Token createToken(Authentication authentication) {
        ...
        Date refreshTokenExpiresIn = new Date(now.getTime() + ACCESS_REFRESH_TOKEN_EXPIRE_TIME);
