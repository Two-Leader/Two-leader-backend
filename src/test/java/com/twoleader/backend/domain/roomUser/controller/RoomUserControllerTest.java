...
public class RoomUserControllerTest {
    ...
    private static final GetRoomUserResponse response = GetRoomUserResponse.builder().userId(1L).userName("tester").build();

    @Test
    @DisplayName("RoomUser 생성 Test")
    public void CreateRoomUserTest() throws Exception {
        // given
        CreateRoomUserRequest request = CreateRoomUserRequest.builder().userUuid(UUID.randomUUID()).userName("tester").build();
