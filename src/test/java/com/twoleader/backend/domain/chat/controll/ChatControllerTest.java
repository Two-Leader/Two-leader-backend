...
public class ChatControllerTest {
    ...
    public class getChatTest{
        ...
        public void whenHasNextPage() throws Exception {
            ...
            for(int i = 0; i < 20;i++){
                chatList.add(GetChatResponse.builder().userId(1L).message("testMessage"+i).time(LocalDateTime.now()).build());
            }
            given(chatService.getChat(any(),any())).willReturn(new PageImpl<>(chatList, PageRequest.of(0,20),40));
