...
public class ChatRepositoryTest {
    ...
    public void setUp(){
        for(int i = 0; i < 20; i++){
            chatRepository.save(Chat.builder().roomUuid(roomUuid1).userId(1L).message("testMessage"+i).build());
            chatRepository.save(Chat.builder().roomUuid(roomUuid2).userId(2L).message("testMessage"+i).build());
        }
    }
